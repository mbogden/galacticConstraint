...
def configure_logging(log_level: str = 'WARNING') -> None:
    ...
    # Assuming MPIRankFilter and RANK are defined elsewhere in your module
    # Create a logger and add the MPIRankFilter if necessary
    logger = logging.getLogger()
    logger.addFilter(MPIRankFilter(RANK))
    # Any other logging configurations can go here
